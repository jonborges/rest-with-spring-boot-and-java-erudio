...
class PersonControllerCorsTest extends AbstractIntegrationTest {
    ...
    void findById() throws JsonProcessingException {
        RequestSpecification specWithCorrectOrigin = new RequestSpecBuilder()
                .addHeader(TestConfigs.HEADER_PARAM_ORIGIN, TestConfigs.ORIGIN_ERUDIO)
                .setBasePath("/api/person/v1")
                .setPort(TestConfigs.SERVER_PORT)
                    .addFilter(new RequestLoggingFilter(LogDetail.ALL))
        ...
        var content = given(specWithCorrectOrigin)
                    .contentType(MediaType.APPLICATION_JSON_VALUE)
    ...
    @Test
    @Order(5)
    void findPersonByNameWithWrongOrigin() throws JsonProcessingException {
        RequestSpecification specWithWrongOrigin = new RequestSpecBuilder()
                .addHeader(TestConfigs.HEADER_PARAM_ORIGIN, TestConfigs.ORIGIN_SEMERU)
                .setBasePath("/api/person/v1")
                .setPort(TestConfigs.SERVER_PORT)
