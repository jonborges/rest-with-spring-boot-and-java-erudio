...
class PersonServicesTest {
    ...
    void findAll() {
        ...
        Page<Person> page = new PageImpl<>(entityList, pageable, entityList.size());
        ...
        var personOne = result.getContent().stream()
                .filter(p -> p.getContent().getId().equals(1L))
                .findFirst()
                .orElse(null).getContent();
        ...
        var personFour = result.getContent().stream()
                .filter(p -> p.getContent().getId().equals(4L))
                .findFirst()
                .orElse(null).getContent();
        ...
        var personSeven = result.getContent().stream()
                .filter(p -> p.getContent().getId().equals(7L))
                .findFirst()
                .orElse(null).getContent();
